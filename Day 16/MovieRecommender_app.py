...
app=ttk.Tk()
app.title('Movie Recommender App')
...
def get_movie():
    ...
    print('Recommandations:',top_recom)
...
ttk.Button(app, text='Find Recommendations', font=('Arial',22),command=get_movie).place(x=10,y=200)
